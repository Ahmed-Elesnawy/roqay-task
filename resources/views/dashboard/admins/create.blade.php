            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">@lang('dashbaord.create_admin')</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('dashboard.admins.store') }}" role="form">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="password_confirmation" type="password" class="form-control"
                                    id="exampleInputPassword1" placeholder="Re-type Password">
                            </div>
...
@push('js')
    <script>
        ...
        rolesSelect.val({!!json_encode(old('roles')) !!}).trigger('change');
    </script>
@endpush
